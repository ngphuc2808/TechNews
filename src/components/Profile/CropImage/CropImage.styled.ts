...
export const ModalBody = styled.div`
  ${tw`fixed top-[50%] left-[50%] bg-[#fff] w-[500px] flex justify-start flex-col z-[999]`}
...
export const Button = styled.button`
  ${tw`w-[125px] bg-[var(--navbar-dark)] py-1.5 px-0 text-white mt-6 tracking-[1px] font-bold flex justify-center items-center hover:text-[var(--primary)]`}
  & p {
    ${tw`ml-1.5`}
  }
  & svg {
...
export const Slider = styled.input`
  ...
  &::-webkit-slider-thumb {
    ${tw`w-5 h-5 appearance-none rounded-[50%] cursor-pointer bg-[var(--navbar-dark)]`}
    -webkit-appearance: none;
  }
  &::-moz-range-thumb {
